...
/// @dev Experimental terminal grouped LogUp verifier. Generated contracts pin the execution
/// profile, fixed-program commitment, program layout, and lifted verifier capacity.
import { LeanVmGroupedExecution as Grouped } from "./LeanVmGroupedExecution.sol";

abstract contract LeanVmGroupedTerminalVerifier {
    ...
    /// @notice Verify the experimental grouped LogUp terminal proof.
    function verifyGroupedLogupV1(Proof calldata proof) external pure returns (bool) {
        ...
        Grouped.verifyWithPublicMemory(
            proof.transcript,
            proof.openings,
