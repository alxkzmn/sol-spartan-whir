...
library WhirBlobCodecLir11 {
    ...
    uint8 internal constant ROUND_COUNT = 1;
    ...
    function _decodeRound0(
        ...
        round.sumcheck.powWitnesses = new uint256[](ROUND0_SUMCHECK_POW_WITNESSES);
        for (uint256 i = 0; i < ROUND0_SUMCHECK_POW_WITNESSES; ++i) {
    ...
    function expectedLength(
        ...
        return HEADER_BYTES + STATEMENT_POINT_ARITY * 16 + STATEMENT_EVALUATIONS * 16
            ...
            + INITIAL_SUMCHECK_POW_WITNESSES * 4 + EFFECTIVE_DIGEST_BYTES + ROUND_OOD_SAMPLES * 16
            + 4 + ROUND0_NUM_QUERIES * ROW_LEN * 4 + round0DecommLen * EFFECTIVE_DIGEST_BYTES
            + ROUND_SUMCHECK_EVALS * 16 + ROUND0_SUMCHECK_POW_WITNESSES * 4 + FINAL_POLY_LEN * 16
            + 4 + FINAL_NUM_QUERIES * ROW_LEN * 16 + finalDecommLen * EFFECTIVE_DIGEST_BYTES
            + FINAL_SUMCHECK_EVALS * 16;
    }
