...
import {
    QuinticWhirFixedConfig_cfsr_pow27_ff4_rest3_lir3_rsv2 as QuinticWhirFixedConfig
} from "../../generated/QuinticWhirFixedConfig_cfsr_pow27_ff4_rest3_lir3_rsv2.sol";
...
contract WhirBlobVerifierNative5_cfsr_pow27_ff4_rest3_lir3_rsv2 {
        ...
        )
    {
        ...
        uint256 expectedLen = 20 + 22 * 20 + 20 + 20 + 20 + 8 * 20 + 4 * 4 + 20 + 20 + 4 + 52 * 16
            * 4 + round0DecommLen * 20 + 6 * 20 + 3 * 4 + 20 + 20 + 4 + 31 * 8 * 20
            + round1DecommLen * 20 + 6 * 20 + 3 * 4 + 20 + 20 + 4 + 22 * 8 * 20 + round2DecommLen
            * 20 + 6 * 20 + 3 * 4 + 20 + 20 + 4 + 17 * 8 * 20 + round3DecommLen * 20
            + 6 * 20 + 3 * 4 + 64 * 20 + 4 + 14 * 8 * 20 + finalDecommLen * 20 + 12 * 20;
    ...
    function verify(bytes32 expectedCommitment, bytes calldata blob) external pure returns (bool) {
...

        {
            ...
            (claimedEval, randomnessCursor, offset) = WhirVerifierCore5._verifySumcheckBlob(
                blob, offset, challenger, claimedEval, 3, 23, allRandomness, randomnessCursor
            );
            prevRoot = round1Root;
        }

        {
            ...
            (claimedEval, randomnessCursor, offset) = WhirVerifierCore5._verifySumcheckBlob(
                blob, offset, challenger, claimedEval, 3, 24, allRandomness, randomnessCursor
            );
            prevRoot = round2Root;
        }

        {
            ...
            (claimedEval, randomnessCursor, offset) = WhirVerifierCore5._verifySumcheckBlob(
                blob, offset, challenger, claimedEval, 3, 25, allRandomness, randomnessCursor
            );
            prevRoot = round3Root;
        }
