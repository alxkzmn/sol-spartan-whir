...
import {
    WhirVerifierCore8PrecompilePhase1 as WhirVerifierCore8
} from "./WhirVerifierCore8PrecompilePhase1.sol";
import { WhirVerifierUtils8 } from "../k22_jb100_lir6_ff4_rsv1/WhirVerifierUtils8.sol";

contract WhirBlobVerifierNative8_k22_jb100_lir6_ff4_rsv1_precompile_phase1 {
    ...
    function verify(bytes32 expectedCommitment, bytes calldata blob) external view returns (bool) {
        ...
        uint256 expected = KoalaBearExt8Precompile.mul(evaluationOfWeights, finalValue);
