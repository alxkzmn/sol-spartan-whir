...
library WhirBlobCodec5 {
    ...
    uint256 internal constant FINAL_SUMCHECK_EVALS = 10;
    ...
    uint256 internal constant ROUND0_ROW_LEN = 32;
    uint256 internal constant ROW_LEN = 16;
    uint256 internal constant FINAL_POLY_LEN = 32;
    ...
    function expectedLength(
        ...
        return HEADER_BYTES + STATEMENT_POINT_ARITY * 20 + STATEMENT_EVALUATIONS * 20
            ...
            + 4 + ROUND0_NUM_QUERIES * ROUND0_ROW_LEN * 4 + round0DecommLen * EFFECTIVE_DIGEST_BYTES
