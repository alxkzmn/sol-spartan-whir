...
import {
    WhirBlobVerifierNative5_cfsr_pow27_ff4_rest3_lir4_rsv4 as Verifier
...
contract WhirBlobNativeTxBenchmarkShortlistCfsrPow27Lir4Script is QuinticShortlistTxBenchmarkBase {
    function run() external returns (address verifierAddress) {
        (bytes32 commitment, bytes memory blob) = _load("cfsr_pow27_ff4_rest3_lir4_rsv4");
        vm.startBroadcast();
