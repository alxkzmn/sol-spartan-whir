...
contract WhirBlobNativeTxBenchmark8Script is Script {
    ...
    function run() external returns (address nativeVerifierAddress) {
        ...
        bytes memory verifyCalldata =
            abi.encodeCall(WhirBlobVerifierNative8.verify, (proof.initialCommitment, blob));
        ...
        WhirBlobVerifierNative8 nativeVerifier = new WhirBlobVerifierNative8();
