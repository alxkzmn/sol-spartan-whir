...
import {
    WhirBlobVerifierNative5_k22_jb100_ext5_lir4_ff4_rsv3_pow28 as WhirBlobVerifierNative5
} from "../src/whir/k22_jb100_ext5_lir4_ff4_rsv3_pow28/WhirBlobVerifierNative5_k22_jb100_ext5_lir4_ff4_rsv3_pow28.sol";

contract WhirBlobNativeTxBenchmark5Pow28Rsv3Script is Script {
    ...
    function run() external returns (address nativeVerifierAddress) {
        ...
        bytes memory verifyCalldata =
            abi.encodeCall(WhirBlobVerifierNative5.verify, (proof.initialCommitment, blob));
        ...
        WhirBlobVerifierNative5 nativeVerifier = new WhirBlobVerifierNative5();
