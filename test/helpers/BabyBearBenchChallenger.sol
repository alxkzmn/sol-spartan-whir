...
// Test-only BabyBear adaptation of src/transcript/KeccakChallenger.sol.
// The PoW comparison uses checkWitness, which samples bits without field rejection.

library BabyBearBenchChallenger {
