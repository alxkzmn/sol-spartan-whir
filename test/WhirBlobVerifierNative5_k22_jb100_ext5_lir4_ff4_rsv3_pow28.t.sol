...
import {
    WhirBlobVerifier5_k22_jb100_ext5_lir4_ff4_rsv3_pow28
} from "../src/whir/k22_jb100_ext5_lir4_ff4_rsv3_pow28/WhirBlobVerifier5_k22_jb100_ext5_lir4_ff4_rsv3_pow28.sol";
import {
    WhirBlobVerifierNative5_k22_jb100_ext5_lir4_ff4_rsv3_pow28
} from "../src/whir/k22_jb100_ext5_lir4_ff4_rsv3_pow28/WhirBlobVerifierNative5_k22_jb100_ext5_lir4_ff4_rsv3_pow28.sol";
import {
    WhirVerifier5_k22_jb100_ext5_lir4_ff4_rsv3_pow28
} from "../src/whir/k22_jb100_ext5_lir4_ff4_rsv3_pow28/WhirVerifier5_k22_jb100_ext5_lir4_ff4_rsv3_pow28.sol";
import {
    WhirVerifierCore5
...
contract QuinticNativePrefixHarnessPow28Rsv3 {
        ...
        returns (uint256[] memory samples)
    {
        ...
        WhirVerifierCore5._checkWitnessBaseLeBlob(challenger, 27, blob, offset);
...
contract WhirBlobVerifierNative5K22Jb100Ext5Pow28Rsv3Test is Test {
    ...
    WhirVerifier5_k22_jb100_ext5_lir4_ff4_rsv3_pow28 internal verifier;
    WhirBlobVerifier5_k22_jb100_ext5_lir4_ff4_rsv3_pow28 internal blobVerifier;
    WhirBlobVerifierNative5_k22_jb100_ext5_lir4_ff4_rsv3_pow28 internal nativeBlobVerifier;
    QuinticNativePrefixHarnessPow28Rsv3 internal prefixHarness;
    ...
    function setUp() external {
        verifier = new WhirVerifier5_k22_jb100_ext5_lir4_ff4_rsv3_pow28();
        blobVerifier = new WhirBlobVerifier5_k22_jb100_ext5_lir4_ff4_rsv3_pow28(verifier);
        nativeBlobVerifier = new WhirBlobVerifierNative5_k22_jb100_ext5_lir4_ff4_rsv3_pow28();
        prefixHarness = new QuinticNativePrefixHarnessPow28Rsv3();
    }
    ...
    function testNativePrefixRound0SamplesMatchTrace() external view {
        ...
        assertEq(samples[0], 482_235);
        assertEq(samples[1], 3_234_735);
        assertEq(samples[2], 3_642_924);
        assertEq(samples[36], 585_179);
        assertEq(samples[37], 3_778_865);
    }
    ...
    function testRejectsBadCommitmentBlobNative() external {
        ...
        bytes memory blob = vm.readFileBinary(
            string.concat(
                TESTDATA,
                "quintic_whir_k22_jb100_ext5_lir4_ff4_rsv3_pow28_failure_bad_commitment.blob"
            )
        );
        vm.expectRevert();
    ...
    function testRejectsBadStirQueryBlobNative() external {
        ...
        bytes memory blob = vm.readFileBinary(
            string.concat(
                TESTDATA,
                "quintic_whir_k22_jb100_ext5_lir4_ff4_rsv3_pow28_failure_bad_stir_query.blob"
            )
        );
        vm.expectRevert();
        nativeBlobVerifier.verify(success.initialCommitment, blob);
    ...
    function testRejectsBadOodBlobNative() external {
        ...
        bytes memory blob = vm.readFileBinary(
            string.concat(
                TESTDATA,
                "quintic_whir_k22_jb100_ext5_lir4_ff4_rsv3_pow28_failure_bad_ood_or_transcript_mismatch.blob"
            )
        );
        vm.expectRevert();
        nativeBlobVerifier.verify(success.initialCommitment, blob);
    ...
    function testRejectsMalformedInitialOodAnswersBlobNative() external {
        ...
        for (uint256 lane = 0; lane < 5; ++lane) {
            bytes memory blob = vm.readFileBinary(
                string.concat(
                    TESTDATA, "quintic_whir_k22_jb100_ext5_lir4_ff4_rsv3_pow28_success.blob"
                )
            );
        ...
        returns (WhirStructs.WhirStatement memory statement, WhirStructs.WhirProof memory proof)
    {
        statement = abi.decode(
            vm.readFileBinary(
                string.concat(
                    TESTDATA,
                    "quintic_whir_k22_jb100_ext5_lir4_ff4_rsv3_pow28_success_statement.abi"
                )
            ),
